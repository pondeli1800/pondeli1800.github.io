document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    // Honeypot
    if (data.get('website')) return; // spam detected, ignore
    ...
    try {
      const response = await fetch('https://script.google.com/macros/s/AKfycbzot1ZEPWTXLatMMqZB93oTaKeIYS0zZ9vMBlywLY3-vrJl7rITU51EwxEGkX2j6ufBGg/exec', {
        method: 'POST',
